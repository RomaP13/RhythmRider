...
"}")
        ...
        self.horizontalLayoutWidget_5.setGeometry(QRect(0, 0, 551, 351))
...
"")
        ...
        self.playPauseBtn.setWhatsThis(u"")
...
"}")
        ...
        self.githubBtn.setToolTipDuration(2)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.aboutPlayerLabel.setText(QCoreApplication.translate("MainWindow", u"The convenient and simple player for enjoying your favorite songs and artists.", None))
        self.titleLabel_5.setText(QCoreApplication.translate("MainWindow", u"Used libraries", None))
#if QT_CONFIG(whatsthis)
        self.pyside6Btn.setWhatsThis(QCoreApplication.translate("MainWindow", u"About Qt", None))
#endif // QT_CONFIG(whatsthis)
        self.pyside6Btn.setText(QCoreApplication.translate("MainWindow", u"PySide6", None))
#if QT_CONFIG(whatsthis)
        self.pygameBtn.setWhatsThis(QCoreApplication.translate("MainWindow", u"https://www.pygame.org/", None))
#endif // QT_CONFIG(whatsthis)
        self.pygameBtn.setText(QCoreApplication.translate("MainWindow", u"pygame", None))
#if QT_CONFIG(whatsthis)
        self.mutagenBtn.setWhatsThis(QCoreApplication.translate("MainWindow", u"https://mutagen.readthedocs.io/en/latest/", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.githubBtn.setStatusTip(QCoreApplication.translate("MainWindow", u"https://github.com/RomaP13/RhythmRider", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.githubBtn.setWhatsThis(QCoreApplication.translate("MainWindow", u"https://github.com", None))
#endif // QT_CONFIG(whatsthis)
